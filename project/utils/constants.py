...
right_eye_keypoints = {k: v for k, v in eye_keypoints.items() if 'right_' in v}
left_eye_keypoints = {k: v for k, v in eye_keypoints.items() if 'lift_' in v}

inv_eye_keypoints = {v: k for k, v in eye_keypoints.items()}
